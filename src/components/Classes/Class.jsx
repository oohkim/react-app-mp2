            ...
            <div className="card-container">
                <div className="card">
                    ...
                    <div className="intro">
                        ...
                        <p>These classes focus on cardiovascular fitness and can include activities like spinning, aerobics, and dance workouts.</p>
                    </div>
                </div>
                <div className="card">
                    <h4>CROSSFIT</h4>
                    ...
                    <div className="intro">
                        ...
                        <p>CrossFit combines weightlifting, aerobic exercises, and high-intensity functional movements in a group setting to improve overall fitness</p>
                    </div>
                </div>
                <div className="card">
                    <h4>KICKBOXING</h4>
                    ...
                    <div className="intro">
                        ...
                        <p>Kickboxing classes combine martial arts techniques with cardiovascular training, enhancing agility and self-defense skills.</p>
                    </div>
                </div>
            </div>
